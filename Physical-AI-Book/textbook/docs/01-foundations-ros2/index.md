...
- ✅ Ubuntu 22.04 with ROS 2 Humble installed (see [Prerequisites](../00-preface/prerequisites.md))
...
1. **Check the Glossary**: [Appendix - Glossary](../99-appendices/glossary.md) defines all ROS 2 terminology
